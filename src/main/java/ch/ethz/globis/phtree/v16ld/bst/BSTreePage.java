...
public class BSTreePage {
	...
	public final BSTEntry getOrCreate(long key, Node ind) {
	...
	private BSTEntry create(long key, int pos, Node ind) {
	...
	public <T> Object computeLeaf(long key, long[] kdKey, Node node,
	...
	private BSTEntry addForCompute(long key, int pos, Node node) {
